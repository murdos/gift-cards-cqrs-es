...
public record GiftCardDetails(Barcode barcode, List<String> details) {
  public static GiftCardDetails from(GiftCardHistory history) {
    ...
    return followingEvents
      ...
      .reduce(
        new GiftCardDetails(
          firstEvent.barcode(),
          List.of("Nouvelle carte cadeau : " + firstEvent.amount().value() + " €" + " chez " + firstEvent.shoppingStore())
        ),
  ...
  private static GiftCardDetails reducer(GiftCardDetails giftCardDetails, GiftCardEvent giftCardEvent) {
