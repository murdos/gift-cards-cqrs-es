package net.murdos.giftcards.shared.collection.domain;
...
@UnitTest
class GiftCardsCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class GiftCardsCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = GiftCardsCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = GiftCardsCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class GiftCardsCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = GiftCardsCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = GiftCardsCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class GiftCardsCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = GiftCardsCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = GiftCardsCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class GiftCardsMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = GiftCardsCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = GiftCardsCollections.immutable(input);
