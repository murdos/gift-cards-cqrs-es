...
[.notes]
--
- Et bien au niveau de l'EventPublisher, *click* des events handlers vont venir s'abonner aux évènements.
--
...
=== `GiftCardCurrentStateUpdater.initializeState()`
...
[source, java, highlight="4..|5,10|6..9"]
----
@QueryModel
